...
| `Rdpeek.Companion` — multi-connection helper + one-click agent bootstrap | ✅ built; RDP-window enumeration + command builder verified; input injection build-verified, live test pending |
